...
typedef struct tagc1101OutBlock    //종목마스타기본자료 1353byte + 168 = 1521
{
	char code                             [  6];	char _code;                               //종목코드             
...
typedef struct tagc1101OutBlock2    //변동거래량자료, [반복] 53 + 8 = 61
{
...
typedef struct tagc1101OutBlock3    //종목지표 76 + 15 = 91
{
...
typedef struct tagh1OutBlock    //출력 361 bytes
{
	char code                             [  6];   //종목코드             
	char hotime                           [  8];   //시간                 
	char offer                            [  7];   //매도호가             
...
typedef struct tagk3OutBlock    //출력 361 bytes
{
	char code                             [  6];   //종목코드             
	char hotime                           [  8];   //시간                 
	char offer                            [  7];   //매도호가             
...
typedef struct tagh2InBlock    //입력 시간외 호가 잔량
{
	char code                             [  6];   //종목코드             
} Th2InBlock;
...
typedef struct tagh3InBlock    //입력 예상호가잔량
{
	char code                             [  6];   //종목코드             
} Th3InBlock;
...
typedef struct tagj8InBlock    //입력 코스피 실시간 체결
{
	char code                             [  6];	char _code;                               //종목코드             
} Tj8InBlock;
...
typedef struct tagj8OutBlock    //출력
{
	char code                             [  6];	char _code;                               //종목코드             
	char time                             [  8];	char _time;                               //시간                 
	char sign                             [  1];	char _sign;                               //전일종가대비 등락부호(시가대비는 아닐지?)
	char change                           [  6];	char _change;                             //전일종가대비 가격등락폭
	char price                            [  7];	char _price;                              //현재가               
	char chrate                           [  5];	char _chrate;                             //전일종가대비 등락률               
	char high                             [  7];	char _high;                               //고가                 
	char low                              [  7];	char _low;                                //저가                 
	char offer                            [  7];	char _offer;                              //매도호가             
	char bid                              [  7];	char _bid;                                //매수호가             
	...
	char movolume                         [  8];	char _movolume;                           //변동거래량(체결수량)           
	char value                            [  9];	char _value;                              //누적거래대금             
	char open                             [  7];	char _open;                               //시가                 
	char avgprice                         [  7];	char _avgprice;                           //가중평균가           
	char janggubun                        [  1];	char _janggubun;                          //장구분(정규장:0)
} Tj8OutBlock;
...
typedef struct tagk8InBlock    //입력 코스닥 실시간 체결
{
	char code                             [  6];	char _code;                               //종목코드             
} Tk8InBlock;
...
typedef struct tagk8OutBlock    //출력
{
	...
	char time                             [  8];	char _time;                               //시간                 
	char price                            [  7];	char _price;                              //현재가               
	char sign                             [  1];	char _sign;                               //전일종가대비 등락부호
	char change                           [  6];	char _change;                             //전일종가대비 가격등락폭
	char chrate                           [  5];	char _chrate;                             //전일종가대비 등락률               
	char high                             [  7];	char _high;                               //고가                 
	char low                              [  7];	char _low;                                //저가                 
...
// 2020.04.12 추가 
// 주식/ELW/선물/옵션/ KRX코드리스트(p1005)

typedef struct tagp1005InBlock    //입력Data
{
	/*1:주식,2:ELW,3:선물,4:옵션,5:주식(코스피),6:주식(코스닥)*/
    char gubun                            [  1];    char _gubun;                              //검색구분 
} Tp1005InBlock;

typedef struct tagp1005OutBlock    //코드출력Data, [반복]
{
    char code                             [  6];    char _code;                               //단축코드              
    char expcode                          [ 12];    char _expcode;                            //KRX코드               
    char hnamez40                         [ 40];    char _hnamez40;                           //종목명                
} Tp1005OutBlock;

typedef struct tagp1005
{
    Tp1005InBlock                     p1005inblock                          ;  //입력Data 
    Tp1005OutBlock                    p1005outblock                    [ 20];  //코드출력Data , [반복]
} Tp1005;
